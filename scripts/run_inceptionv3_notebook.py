"""Execute the training notebook with saved outputs using installed IPython.
...
NOTEBOOK = ROOT / "notebooks/04_inceptionv3_training.ipynb"
...
def main():
    ...
    for cell in notebook["cells"]:
        ...
        def capture_show(*args, **kwargs):
            for number in plt.get_fignums():
                ...
                outputs.append({"output_type": "display_data", "data": {
                    ...
                    "text/plain": "<InceptionV3 training figure>"}, "metadata": {}})
                plt.close(figure)
        ...
        notebook["metadata"]["training_execution"] = {
    ...
    notebook["metadata"]["training_execution"]["completed"] = True
    NOTEBOOK.write_text(json.dumps(notebook, indent=1, ensure_ascii=False) + "\n", encoding="utf-8")
